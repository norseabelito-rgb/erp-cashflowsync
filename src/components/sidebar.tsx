...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: "Recepție Depozit", href: "/inventory/reception", icon: PackageCheck, permissions: ["inventory.view"] },
      { name: "Precomandă", href: "/inventory/purchase-orders", icon: ShoppingCart, permissions: ["inventory.view"] },
      { name: "Facturi Furnizori", href: "/inventory/supplier-invoices", icon: FileText, permissions: ["inventory.view"] },
