...
export const INVOICE_ERROR_MESSAGES: Record<string, string> = {
  ...
  NO_CREDENTIALS: "Credentialele Oblio nu sunt configurate pentru firma. Mergi la Setari > Firme pentru a configura.",
  NO_OBLIO_CIF: "CIF-ul Oblio nu este configurat pentru firma. Mergi la Setari > Firme pentru a configura.",
  ...
  CLIENT_ERROR: "Nu s-a putut crea clientul Oblio. Verifica credentialele.",
  OBLIO_ERROR: "Eroare la comunicarea cu Oblio. Incearca din nou.",
  OBLIO_AUTH_ERROR: "Autentificare esuata la Oblio. Verifica credentialele in Setari > Firme.",
  OBLIO_UNAVAILABLE: "Oblio nu este disponibil momentan. Incearca din nou in cateva minute.",
