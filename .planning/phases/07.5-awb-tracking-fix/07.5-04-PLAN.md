...
This task ensures dashboard uses the same categorization as the refactored awb-status.ts.
  ...
  <verify>Start dev server, load dashboard and tracking page. Compare "Expediate" count on dashboard with "In tranzit" total on tracking page - they must match.</verify>
