...
3. Rename stats property from "shipped" to "inTransit" for clarity (update dashboard page.tsx accordingly)
...
<task type="auto">
  <name>Task 3: Update tracking page to use shared module</name>
