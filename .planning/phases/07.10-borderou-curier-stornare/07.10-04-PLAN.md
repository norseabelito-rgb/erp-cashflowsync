...
This method mirrors the pattern of cancelInvoice but uses the /docs/invoice/collect endpoint.
  ...
  <verify>OblioAPI class has collectInvoice method that accepts seriesName, number, collectType, collectDate</verify>
  <done>Oblio client extended with collectInvoice method for marking invoices as paid</done>
</task>
