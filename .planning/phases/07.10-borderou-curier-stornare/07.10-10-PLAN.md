...
must_haves:
  ...
  artifacts:
    ...
    - path: "src/app/(dashboard)/returns/page.tsx"
      provides: "Returns page with manifest generation button"
...
2. Update the fetch call to include pagination params:
```typescript
...
- Page displays correct range (e.g., "Afisare 1 - 50 din 150")
  ...
  <done>Returns page updated with pagination controls to navigate all returns</done>
</task>
